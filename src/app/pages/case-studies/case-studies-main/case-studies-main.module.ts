...
import { CaseStudiesMainComponent } from './case-studies-main.component';
...
const routes: Routes = [
  {
    path: '',
    component: CaseStudiesMainComponent,
  },
];

@NgModule({
  declarations: [
    CaseStudiesMainComponent
  ],
  imports: [
    CommonModule,
    SharedModuleModule,
...
export class CaseStudiesMainModule { }
