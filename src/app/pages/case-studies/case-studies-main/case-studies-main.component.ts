...
@Component({
  selector: 'app-case-studies-main',
  templateUrl: './case-studies-main.component.html',
  styleUrls: ['./case-studies-main.component.scss']
})
export class CaseStudiesMainComponent implements OnInit {
