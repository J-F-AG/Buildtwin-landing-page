...
@Component({
  selector: 'app-data-center-hd-discover-projects',
...
export class DataCenterHdDiscoverProjectsComponent implements OnInit {
  ...
  splitArray(dataArray: any[], x: number) {
    ...
    projectsArray = [
      { img: 'https://s3.ap-southeast-1.amazonaws.com/buildtwin-prod-cockpit.buildtwin.com/bt-assets/resource/privateS3/upload/business-listing-image/public/20240808/file_d4a85290-969e-4d9b-b185-137c640430fa.jpg', category: 'Structural', projectTitle: 'FR8.2 Data Center', company: 'Frankfurt, Germany', locationFlag: 'assets/images/ui/germany.png', serviceCompany: 'GBC Engineering', serviceCompanyIcon: 'assets/images/gbcEngineering.webp', width:'57', height:'30', serviceDescription: "Services: - Structural Design, work stage 4-6 (LP4-6) - Workshop Design for ...", linkTitle: 'Learn More about GBC Engineering', link: '/partners/gbc-engineers', alt: 'Germany Flag' },
      { img: 'assets/images/high-building.webp', category: 'Structural', projectTitle: 'High-Rise Buildings', company: 'FOURFrankfurt', locationFlag: 'assets/images/ui/germany.png', serviceCompany: 'J&F India', serviceCompanyIcon: 'assets/images/jf-icon.webp', width:'59', height:'30', serviceDescription: "1 million € construction costs electrical | approx. 22,000 m²", linkTitle: 'Learn More about J&F India', link: '/partners/j-f-india', alt: 'Germany Flag' },
