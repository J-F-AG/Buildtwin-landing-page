...
@Component({
  selector: 'app-steel-detailing-usa-sample-drawing',
  // standalone: true,
  // imports: [],
  templateUrl: './sample-drawing.component.html',
  styleUrl: './sample-drawing.component.scss'
})
export class SteelDetailingUsaSampleDrawingComponent{
  ...
  splitArray(dataArray: any[], x: number) {
    ...
    projectsArray = [
      { img: 'assets/images/drawing1.jpg', img2x: 'assets/images/drawing1@2x.jpg', webp: 'assets/images/drawing1.webp', webp2x: 'assets/images/drawing1@2x.webp', category: 'MEP', projectTitle: 'Logistics Hall Construction', company: 'HBM Darmstadt', companyIcon: 'assets/images/gpcEngineering.png', serviceCompany: 'GBC Engineering', serviceCompanyIcon: 'assets/images/drawingLogoImg2.png', width:'84', height:'44', serviceDescription: "Structural Design, work stage 1-6 (LP1-6) | Steel Structure Design...", linkTitle: 'Learn More about GBC Engineering', link: '/partners/gbc-engineers' },
      { img: 'assets/images/drawing2.jpg', img2x: 'assets/images/drawing2@2x.jpg', webp: 'assets/images/drawing2.webp', webp2x: 'assets/images/drawing2@2x.webp', category: 'Structural', projectTitle: 'High-Rise Buildings', company: 'FOURFrankfurt', companyIcon: 'assets/images/cpbContractors.png', serviceCompany: 'AARBEE', serviceCompanyIcon: 'assets/images/drawingLogoImg1.png', width:'70', height:'45', serviceDescription: "Type of building: Duct | Tonnage: 3,800 Tons", linkTitle: 'Learn More about Aarbee', link: '/partners/aarbee-structures-private-limited' },
      { img: 'assets/images/drawing3.jpg', img2x: 'assets/images/drawing3@2x.jpg', webp: 'assets/images/drawing3.webp', webp2x: 'assets/images/drawing3@2x.webp', category: 'MEP', projectTitle: 'Construction Modular Dormitory', company: 'FOURFrankfurt', companyIcon: 'assets/images/gpcEngineering.png', serviceCompany: 'J&F India', serviceCompanyIcon: 'assets/images/jf-icon.jpg', width:'84', height:'44', serviceDescription: "1 million € construction costs electrical | approx. 22,000 m²", linkTitle: 'Learn More about J&F India', link: '/partners/j-f-india' },
      { img: 'assets/images/drawing1.jpg', img2x: 'assets/images/drawing1@2x.jpg', webp: 'assets/images/drawing1.webp', webp2x: 'assets/images/drawing1@2x.webp', category: 'MEP', projectTitle: 'Logistics Hall Construction', company: 'HBM Darmstadt', companyIcon: 'assets/images/cpbContractors.png', serviceCompany: 'MoldTek', serviceCompanyIcon: 'assets/images/moldtek-icon.jpg', width:'70', height:'45', serviceDescription: "Tonnage: 2,800 Tons", linkTitle: 'Learn More about MoldTek', link: '/partners/mold-tek-technologies-limited' }
