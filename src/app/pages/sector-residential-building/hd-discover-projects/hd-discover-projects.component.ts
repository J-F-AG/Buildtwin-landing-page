...
@Component({
  selector: 'app-residential-building-hd-discover-projects',
...
export class ResidentialBuildingHdDiscoverProjectsComponent implements OnInit {
  ...
  splitArray(dataArray: any[], x: number) {
    ...
    projectsArray = [
      { img: 'https://s3.ap-southeast-1.amazonaws.com/buildtwin-prod-cockpit.buildtwin.com/bt-assets/resource/privateS3/upload/business-listing-image/public/20240808/file_d4a85290-969e-4d9b-b185-137c640430fa.jpg', category: 'Structural', projectTitle: 'FR8.2 Data Center', company: 'Frankfurt, Germany', locationFlag: 'assets/images/ui/germany.png', serviceCompany: 'GBC Engineering', serviceCompanyIcon: 'assets/images/gbcEngineering.png', width:'57', height:'30', serviceDescription: "Services: - Structural Design, work stage 4-6 (LP4-6) - Workshop Design for ...", linkTitle: 'Learn More about GBC Engineering', link: '/partners/gbc-engineers', alt: 'Germany Flag' },
