...
const routes: Routes = [
  {
    ...
    data: {
      ...
      description:
        'Buildtwin is a marketplace for structural engineering services in the AEC industry. Connect with pre-qualified vendors, manage projects, and streamline tendering and bidding with our SaaS platform."',
...

  {
    ...
    data: {
      ...
      description:
        "BuildTwin's AI Design Manager simplifies structural engineering projects with AI assistance at every step. Features collaboration and planning tools. Trusted by over 5,000 engineers",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      title:
        "AI-driven Business Intelligence Platform for AEC Industry | BuildTwin",
      description:
        "BuildTwin's AI-driven Business Intelligence platform for AEC industry that offers a comprehensive understanding of your technical teams' commercial performance. Gain valuable insights and optimize your operations for success.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Provide your structural engineering services worldwide with Buildtwin. Access global projects and clients through our trusted platform.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Connect with global AEC solution providers on BuildTwin. Manage structural engineering projects with our AI platform. Register to bid and post projects today.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Gain skills to bid on new projects with BuildTwin Training. Co-developed by industry leaders, covering software, building codes, technical solutions, and productivity improvements.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  { path: "pricing", component: PricingPageComponent },
  {
    ...
    data: {
      ...
      description:
        "Buildtwin matches engineering teams with pre-qualified vendors. Features include Global Marketplace access, AI Project Management, Specialized Training, and AI-powered Business Intelligence to ensure project success.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      title:
        "Explore Use Cases of BuildTwin for Enhanced Project Outcomes | BuildTwin",
      description:
        "BuildTwin transforms project outcomes with innovative use cases. Explore applications across AEC industry for improved efficiency and collaboration.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Find answers to common questions about Buildtwin's structural engineering marketplace, AI project management tools, data safety, integrations, training programs, and more.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Ensure data safety and compliance with BuildTwin's secure project management platform for structural engineers. Collaborate confidently with our privacy-focused tools.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Seamlessly connect BuildTwin with your CDE/ERP software. Access tailored solutions designed to enhance your experience and boost productivity.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Reach out to Buildtwin for any inquiries about our structural engineering services, AI tools, marketplace, integrations, or training. We're here to help you succeed.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  {
    path: "vender-details-sublimestructures",
    component: VenderDetailsSublimeComponent,
  },
  ...
  // },
  {
    ...
    data: {
      ...
      description:
        "Connect with top structural engineering service providers on BuildTwin. Collaborate globally on  precast detailing, BIM modeling, 3D rebar, structural design, and more.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
  ...
  },
  {
    ...
    data: {
      ...
      description:
        "Streamline your projects with BuildTwin's precast detailing services. Select from hundreds of pre-qualified vendors, monitor progress live, and receive internationally compliant drawings",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
      canonical:
        "https://www.buildtwin.com/services/pre-cast-detailing-services",
    },
  },

  {
    ...
    data: {
      title:
        "Rebar Detailing Services | Shop Drawings, 3D Modeling and Footing Detail",
      description:
        "Buildtwin offers rebar detailing services from pre-qualified vendors, including rebar shop drawings, 3D modeling, footing detail, and bar bending schedules for all your construction needs.",
      image: "https://www.buildtwin.com/assets/images/buildtwin.jpg",
