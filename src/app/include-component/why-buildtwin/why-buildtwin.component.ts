...
@Component({
  selector: 'app-why-buildtwin',
  templateUrl: './why-buildtwin.component.html',
  styleUrls: ['./why-buildtwin.component.scss']
})
export class WhyBuildtwinComponent implements OnInit {
